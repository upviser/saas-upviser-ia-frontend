            ...
            <>
              <div className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <Input bgColor={design.checkoutPage.bgColor} inputChange={inputChange} value={sell.email} type={'text'} placeholder={'Email'} name='email' text='text-sm' style={style} />
              ...
              <div className='flex flex-col gap-4'>
                ...
                <div className='flex gap-2'>
                  <div className='flex flex-col gap-2 w-1/2'>
                    ...
                    <Input bgColor={design.checkoutPage.bgColor} inputChange={inputChange} value={sell.firstName} type={'text'} placeholder={'Nombre'} name='firstName' text='text-sm' style={style} />
                  </div>
                  <div className='flex flex-col gap-2 w-1/2'>
                    <p className='text-sm'>Apellido</p>
                    <Input bgColor={design.checkoutPage.bgColor} inputChange={inputChange} value={sell.lastName} type={'text'} placeholder={'Apellido'} name='lastName' text='text-sm' style={style} />
                  </div>
                </div>
                <div className='flex flex-col gap-2'>
                  <p className='text-sm'>Dirección</p>
                  <Input bgColor={design.checkoutPage.bgColor} inputChange={inputChange} value={sell.address} type={'text'} placeholder={'Dirección'} name='address' text='text-sm' style={style} />
                </div>
                <div className='flex flex-col gap-2'>
                  <p className='text-sm'>Número</p>
                  <Input bgColor={design.checkoutPage.bgColor} inputChange={inputChange} value={sell.number} type={'text'} placeholder={'Número'} name='number' text='text-sm' style={style} />
                </div>
                <div className='flex flex-col gap-2'>
                  <p className='text-sm'>Detalles (Opcional)</p>
                  <Input bgColor={design.checkoutPage.bgColor} inputChange={inputChange} value={sell.details!} type={'text'} placeholder={'Detalles'} name='details' text='text-sm' style={style} />
                </div>
                <Shipping bgColor={design.checkoutPage.bgColor} setShipping={setShipping} sell={sell} setSell={setSell} chilexpress={chilexpress} style={style} sellRef={sellRef} dest={dest} setDest={setDest} streets={streets} setStreets={setStreets} />
                {
                  streets.length
                    ? (
                      <div className='flex flex-col gap-2'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <Input bgColor={design.checkoutPage.bgColor} inputChange={inputChange} value={sell.phone} type={'text'} placeholder={'Teléfono'} name='phone' text='text-sm' style={style} />
                  </div>
                </div>
              </div>
            </>

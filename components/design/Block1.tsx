...
export const Block1 = ({ content, index, calls, forms, design, payment, style, storeData, domain, tenantId }: { content: IDesign, index: any, forms: IForm[], calls: ICall[], design: Design, payment: IPayment, style?: any, storeData: IStoreData, domain: any, tenantId: string }) => {
  ...
  return (
    <>
      <PopupPage popup={popup} setPopup={setPopup} cont={cont} design={design} calls={calls} forms={forms} payment={payment} style={style} storeData={storeData} domain={domain} tenantId={tenantId} content={content} />

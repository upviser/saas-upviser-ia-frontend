...
export const Block1 = ({ content, index, calls, forms, design, payment, style, storeData, domain, tenantId, page }: { content: IDesign, index: any, forms: IForm[], calls: ICall[], design: Design, payment: IPayment, style?: any, storeData: IStoreData, domain: any, tenantId: string, page?: any }) => {

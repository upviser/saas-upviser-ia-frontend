...
export const Slider = ({ info, index, forms, calls, design, payment, style, storeData, domain }: { info: IInfo, index: any, forms: IForm[], calls: ICall[], design: Design, payment: IPayment, style?: any, storeData: IStoreData, domain: any }) => {
  ...
  return (
    <>
      <PopupPage popup={popup} setPopup={setPopup} content={content} design={design} calls={calls} forms={forms} payment={payment} storeData={storeData} domain={domain} />
      <div className="z-0">
        <Swiper
